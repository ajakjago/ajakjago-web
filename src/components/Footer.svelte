...
<div class="page-footer {cBase}">
	<div class="w-full container mx-auto py-16 md:py-20 mb-5">
		<!-- Row 1 -->
		<section class={cRowOne}>
			...
			<div class="hidden md:grid grid-cols-3 gap-8">
				<div class="space-y-6">
					...
					<ul class="space-y-3">
						<li>
							<a class="anchor" href="/docs/introduction">Introduction</a>
						</li>
				...
				<div class="space-y-6">
					...
					<ul class="space-y-3">
						...
						<li>
							<a class="anchor" href="/utilities/codeblocks">Utilities</a>
						</li>
					</ul>
				</div>
				<div class="space-y-6">
